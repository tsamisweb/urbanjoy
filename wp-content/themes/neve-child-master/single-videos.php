...
?>  
	<div class="<?php echo esc_attr( $container_class ); ?> single-post-container videos">
		<div class="row">
                          ...
                          <div class="article-top-content">
						    ...
						    <?php 
								...
								if (!empty($parent)) {
									...
									echo '<div class="main-article-categories '. $category[0]->name .'"><a href=' . esc_url( $link  ) .' >'. '<h1><span>'.  $category[0]->name . '</span><h1>'.'</a></div>';
								}
							?>
                    ...
                    <hr>
					<?php get_template_part('template-parts/videos-related-posts'); ?>
					<hr>
